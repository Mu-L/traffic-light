...
### LLM Policy
This is a complex app that relies on interfacing with obscure Android APIs and is thus hard to test and verify. This makes it a poor match for agentic workflows and their use for contributions is heavily discouraged.
